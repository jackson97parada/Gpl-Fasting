...
export const Header = () => {
  ...
  return (
    <div className="pb-10 pt-32 lg:pt-48" id="inicio">
      ...
      <h2 className="mx-auto mb-10 max-w-[385px] text-center font-avantGarde text-lg text-[#024873] md:mx-0 md:max-w-[1400px] md:text-xl lg:mb-28 lg:pt-8 lg:text-[27px] lg:text-[#0378a6]">
        ¡CUIDA DE TU CUERPO ES EL ÚNICO LUGAR QUE TIENES PARA VIVIR!
      </h2>
      <hr className="relative top-10 z-10 mx-auto w-16 rotate-90 rounded-full border-[2.5px] border-[#0378a6]" />
    </div>
  );
};
